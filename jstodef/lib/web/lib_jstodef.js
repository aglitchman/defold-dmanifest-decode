                ...
                if (JsToDef._callback_object) {
                    ...
                    switch (typeof message) {
                        ...
                        case 'string':
                            ...
                            {{{ makeDynCall("viii", "JsToDef._callback_string")}}}(msg_id, msg, msg_arr.length - 1);
                            Module._free(msg);
                            break;
                        case 'object':
                            if (message instanceof ArrayBuffer) {
                                var msg_arr = new Uint8Array(message);
                                var msg = allocate(msg_arr, "i8", ALLOC_NORMAL);
                                ...
                                wasmTable.get(JsToDef._callback_object)(msg_id, msg, msg_arr.length - 1);
                                Module._free(msg);
                            }
                            break;
                        case 'boolean':
